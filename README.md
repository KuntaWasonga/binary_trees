...
### Print function
To match the examples in the tasks, you are given this [function](https://github.com/KuntaWasonga/binary_trees/blob/master/binary_tree_print.c)

This function is used only for visualization purposes. You don’t have to push it to your repo. It may not be used during the correction
---
### [0. New node](https://github.com/KuntaWasonga/binary_trees/blob/master/0-binary_tree_node.c)
...
alex@/tmp/binary_trees$ ./0-node
  ...
  .--(012)--.         .--(402)--.
(006)     (016)     (256)     (512)
alex@/tmp/binary_trees$AOA
```

### [1. Insert left](https://github.com/KuntaWasonga/binary_trees/blob/master/1-binary_tree_insert_left.c)
...
### [2. Insert right](https://github.com/KuntaWasonga/binary_trees/blob/master/2-binary_tree_insert_right.c)
...
### [3. Delete](https://github.com/KuntaWasonga/binary_trees/blob/master/3-binary_tree_delete.c)
...
### [4. Is leaf](https://github.com/KuntaWasonga/binary_trees/blob/master/4-binary_tree_is_leaf.c)
...
### [6. Pre-order traversal](https://github.com/KuntaWasonga/binary_trees/blob/master/6-binary_tree_preorder.c)
...
### [7. In-order traversal](https://github.com/KuntaWasonga/binary_trees/blob/master/7-binary_tree_inorder.c)
...
### [8. Post-order traversal](https://github.com/KuntaWasonga/binary_trees/blob/master/8-binary_tree_postorder.c)
...
### [9. Height](https://github.com/KuntaWasonga/binary_trees/blob/master/9-binary_tree_height.c)
...
### [10. Depth](https://github.com/KuntaWasonga/binary_trees/blob/master/10-binary_tree_depth.c)
...
### [11. Size](https://github.com/KuntaWasonga/binary_trees/blob/master/11-binary_tree_size.c)
...
### [12. Leaves](https://github.com/KuntaWasonga/binary_trees/blob/master/12-binary_tree_leaves.c)
...
### [13. Nodes](https://github.com/KuntaWasonga/binary_trees/blob/master/13-binary_tree_nodes.c)
...
### [14. Balance factor](https://github.com/KuntaWasonga/binary_trees/blob/master/14-binary_tree_balance.c)
...
### [15. Is full](https://github.com/KuntaWasonga/binary_trees/blob/master/15-binary_tree_is_full.c)
...
### [16. Is perfect](https://github.com/KuntaWasonga/binary_trees/blob/master/16-binary_tree_is_perfect.c)
...
### [17. Sibling](https://github.com/KuntaWasonga/binary_trees/blob/master/17-binary_tree_sibling.c)
Write a function that finds the sibling of a node
*    Prototype: **binary_tree_t *binary_tree_sibling(binary_tree_t *node);**
*    Where node is a pointer to the node to find the sibling
*    Your function must return a pointer to the sibling node
*    If node is NULL or the parent is NULL, return NULL
*    If node has no sibling, return NULLO
```
...
### [19. Lowest common ancestor](https://github.com/KuntaWasonga/binary_trees/blob/master/100-binary_trees_ancestor.c)
...
### [20. Level-order traversal](https://github.com/KuntaWasonga/binary_trees/blob/master/101-binary_tree_levelorder.c)
...
### [21. Is complete](https://github.com/KuntaWasonga/binary_trees/blob/master/102-binary_tree_is_complete.c)
...
### [22. Rotate left](https://github.com/KuntaWasonga/binary_trees/blob/master/103-binary_tree_rotate_left.c)
...
int main(void)
{
    ...
    root = binary_tree_node(NULL, 98);
    root->right = binary_tree_node(root, 128);
    root->right->right = binary_tree_node(root->right, 402);AOA
    binary_tree_print(root);
...
### [23. Rotate right](https://github.com/KuntaWasonga/binary_trees/blob/master/104-binary_tree_rotate_right.c)
...
### [25. BST - Insert](https://github.com/KuntaWasonga/binary_trees/blob/master/111-bst_insert.c)
...
### [26. BST - Array to BST](https://github.com/KuntaWasonga/binary_trees/blob/master/112-array_to_bst.c)
...
### [28. BST - Remove](https://github.com/KuntaWasonga/binary_trees/blob/master/114-bst_remove.c)
...
### [29. Big O #BST](https://github.com/KuntaWasonga/binary_trees/blob/master/115-O)
What are the average time complexities of those operations on a Binary Search Tree (one answer per line):
*    Inserting the value n
*    Removing the node with the value n
*    Searching for a node in a BST of size n

### [30. Is AVL](https://github.com/KuntaWasonga/binary_trees/blob/master/120-binary_tree_is_avl.c)
...
### [32. AVL - Array to AVL](https://github.com/KuntaWasonga/binary_trees/blob/master/122-array_to_avl.c)
...
### [33. AVL - Remove](https://github.com/KuntaWasonga/binary_trees/blob/master/123-avl_remove.c)
...
### [34. AVL - From sorted array](https://github.com/KuntaWasonga/binary_trees/blob/master/124-sorted_array_to_avl.c)
Write a function that builds an AVL tree from an array
...
### [37. Heap - Insert](https://github.com/KuntaWasonga/binary_trees/blob/master/131-heap_insert.c)
...
### [38. Heap - Array to Binary Heap](https://github.com/KuntaWasonga/binary_trees/blob/master/132-array_to_heap.c)
...
### [39. Heap - Extract](https://github.com/KuntaWasonga/binary_trees/blob/master/133-heap_extract.c)
...
### [40. Heap - Sort](https://github.com/KuntaWasonga/binary_trees/blob/master/134-heap_to_sorted_array.c)
...
### [41. Big O #Binary Heap](https://github.com/KuntaWasonga/binary_trees/blob/master/135-O)
...
* **Kunta Wasonga** - [KuntaWasonga](https://github.com/KuntaWasonga)
